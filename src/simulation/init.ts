...
export function initUnits() {
  for (var i = 0; i < PU; i++) uP[i].alive = false; poolCounts.uC = 0;
  for (var i = 0; i < PP; i++) pP[i].alive = false; poolCounts.pC = 0;
  for (var i = 0; i < PPR; i++) prP[i].alive = false; poolCounts.prC = 0;
  beams.length = 0;

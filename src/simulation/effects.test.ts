...
describe('boostTrail', () => {
  it('rng < 閾値でパーティクルが1個生成される', () => {
    ...
    const idx = spawnAt(0, 0, 100, 100);
    const before = poolCounts.particleCount;
    boostTrail(getUnit(idx), 1 / 30, rng);

...
export function initBuffers() {
  ...
  iD = new Float32Array(MAX_INSTANCES * 9);
  iB = gl.createBuffer()!;

  mmD = new Float32Array(MINIMAP_MAX * 9);
  mmB = gl.createBuffer()!;
  ...
  gl.vertexAttribPointer(Loc.aO, 2, gl.FLOAT, false, STRIDE_BYTES, 0);
  gl.vertexAttribDivisor(Loc.aO, 1);
  gl.enableVertexAttribArray(Loc.aS);
  gl.vertexAttribPointer(Loc.aS, 1, gl.FLOAT, false, STRIDE_BYTES, 8);
  gl.vertexAttribDivisor(Loc.aS, 1);
  gl.enableVertexAttribArray(Loc.aC);
  gl.vertexAttribPointer(Loc.aC, 4, gl.FLOAT, false, STRIDE_BYTES, 12);
  gl.vertexAttribDivisor(Loc.aC, 1);
  gl.enableVertexAttribArray(Loc.aA);
  gl.vertexAttribPointer(Loc.aA, 1, gl.FLOAT, false, STRIDE_BYTES, 28);
  gl.vertexAttribDivisor(Loc.aA, 1);
  gl.enableVertexAttribArray(Loc.aSh);
  gl.vertexAttribPointer(Loc.aSh, 1, gl.FLOAT, false, STRIDE_BYTES, 32);
  ...
  gl.vertexAttribPointer(mmLoc.aO, 2, gl.FLOAT, false, STRIDE_BYTES, 0);
  gl.vertexAttribDivisor(mmLoc.aO, 1);
  gl.enableVertexAttribArray(mmLoc.aS);
  gl.vertexAttribPointer(mmLoc.aS, 1, gl.FLOAT, false, STRIDE_BYTES, 8);
  gl.vertexAttribDivisor(mmLoc.aS, 1);
  gl.enableVertexAttribArray(mmLoc.aC);
  gl.vertexAttribPointer(mmLoc.aC, 4, gl.FLOAT, false, STRIDE_BYTES, 12);
  gl.vertexAttribDivisor(mmLoc.aC, 1);
  gl.enableVertexAttribArray(mmLoc.aSY);
  gl.vertexAttribPointer(mmLoc.aSY, 1, gl.FLOAT, false, STRIDE_BYTES, 28);
  gl.vertexAttribDivisor(mmLoc.aSY, 1);
  gl.enableVertexAttribArray(mmLoc.aSh);
  gl.vertexAttribPointer(mmLoc.aSh, 1, gl.FLOAT, false, STRIDE_BYTES, 32);

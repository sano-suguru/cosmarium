...
//   24:Colossus  25:CarrierBay  26:Accelerator  27:Syndicate  28:Bloodborne  29-31:reserved
...
const float RIM_THRESH[NUM_SHAPES]=float[NUM_SHAPES](
  ...
  // 24-28: Colossus CarrierBay Accelerator Syndicate Bloodborne  29-31: reserved
  0.018, 0.022, 0.025, 0.024, 0.020, 0.020, 0.020, 0.020,
...
const float RIM_WEIGHT[NUM_SHAPES]=float[NUM_SHAPES](
  ...
  0.40, 0.38, 0.45, 0.42,
  // 24-28: Colossus CarrierBay Accelerator Syndicate Bloodborne  29-31: reserved
  0.35, 0.40, 0.42, 0.38, 0.45, 0.38, 0.38, 0.38,
  // 32-36: Circle Diamond Homing Beam Lightning
...
const float HF_WEIGHT[NUM_SHAPES]=float[NUM_SHAPES](
  ...
  0.26, 0.32, 0.30, 0.28,
  // 24-28: Colossus CarrierBay Accelerator Syndicate Bloodborne  29-31: reserved
  0.25, 0.30, 0.35, 0.32, 0.28, 0.48, 0.48, 0.48,
  // 32-36: Circle Diamond Homing Beam Lightning
...
const float FWIDTH_MULT[NUM_SHAPES]=float[NUM_SHAPES](
  ...
  0.95, 1.1, 1.1, 1.1,
  // 24-28: Colossus CarrierBay Accelerator Syndicate Bloodborne  29-31: reserved
  0.90, 1.0, 1.1, 1.0, 0.95, 1.5, 1.5, 1.5,
  // 32-36: Circle Diamond Homing Beam Lightning
  1.5, 1.5, 1.5, 1.5, 1.5,
  // 37-41: ExpRing DiamondRing OctShield ReflectField Bar  42: Trail
  1.5, 1.5, 1.5, 1.5, 1.5,

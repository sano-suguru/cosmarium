...
const float RIM_THRESH[27]=float[27](
  0.020,0.020,0.020,0.020,0.020, // 0-4  sh0=Drone,sh1=Fighter,sh2=Bomber,sh3=N/A,sh4=N/A
  0.020,0.020,0.020,0.020,0.020, // 5-9  sh5=BeamFrig,sh6=Launcher,sh7=Carrier,sh8=Sniper,sh9=Lancer
  0.020,0.020,0.020,0.020,0.020, // 10-14
  0.020,0.020,0.020,0.020,0.020, // 15-19
  0.020,0.020,0.020,0.020,0.018, // 20-24 sh24=Flagship
  0.018,0.018                    // 25-26 sh25=Healer,sh26=Reflector
);
const float RIM_WEIGHT[27]=float[27](
  0.35,0.40,0.40,0.38,0.38, // 0-4
  0.40,0.50,0.38,0.40,0.38, // 5-9
  0.38,0.38,0.38,0.38,0.38, // 10-14
  0.38,0.38,0.38,0.38,0.38, // 15-19
  0.38,0.38,0.38,0.38,0.40, // 20-24 sh24=Flagship
  0.38,0.38                  // 25-26
);
const float HF_WEIGHT[27]=float[27](
  0.50,0.50,0.50,0.48,0.48, // 0-4
  0.48,0.60,0.48,0.48,0.48, // 5-9
  0.48,0.45,0.48,0.45,0.48, // 10-14 sh11=Disruptor,sh13=Teleporter
  0.46,0.50,0.48,0.48,0.48, // 15-19 sh15=Arcer,sh16=Cruiser
  0.48,0.48,0.48,0.48,0.52, // 20-24 sh24=Flagship
  0.48,0.44                  // 25-26 sh25=Healer,sh26=Reflector
);
const float FWIDTH_MULT[27]=float[27](
  1.5,1.5,1.5,1.5,1.5, // 0-4
  1.5,1.5,1.5,1.5,1.5, // 5-9
  1.5,1.5,1.5,1.5,1.5, // 10-14
  1.5,1.5,1.5,1.5,1.5, // 15-19
  1.5,1.5,1.5,1.5,1.35,// 20-24 sh24=Flagship
  1.4,1.4               // 25-26 sh25=Healer,sh26=Reflector
);
void main(){
